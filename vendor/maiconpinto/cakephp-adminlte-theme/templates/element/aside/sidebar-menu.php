<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li><a href="<?php echo $this->Url->build(['controller' => 'Citizens', 'action' => 'index']); ?>"><i class="fa fa-circle-o"></i>Citizens</a></li>
      <li><a href="<?php echo $this->Url->build(['controller' => 'Reports', 'action' => 'index']); ?>"><i class="fa fa-circle-o"></i>Reports</a></li>
      <li><a href="<?php echo $this->Url->build(['controller' => 'Responses', 'action' => 'index']); ?>"><i class="fa fa-circle-o"></i>responses</a></li>
      <li><a href="<?php echo $this->Url->build(['controller' => 'Officers', 'action' => 'index']); ?>"><i class="fa fa-circle-o"></i>Officers</a></li>
      <li><a href="<?php echo $this->Url->build(['controller' => 'Levels', 'action' => 'index']); ?>"><i class="fa fa-circle-o"></i>Levels</a></li>
    </ul>
  </li>
  <!-- <li class="treeview">
    <a href="#">
