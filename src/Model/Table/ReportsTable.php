 ...
 * Reports Model
 *
 * @property \App\Model\Table\CitizensTable&\Cake\ORM\Association\BelongsTo $Citizens
...
class ReportsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn('citizen_id', 'Citizens'), ['errorField' => 'citizen_id']);
