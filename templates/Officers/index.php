...
<section class="content-header">
    <h1>
        ...
        <div class="pull-right"><?= $this->Html->link(__('New Officer'), ['action' => 'add'], ['class' => 'btn btn-success btn-xs']) ?></div>
    </h1>
</section>
                            ...
                            <?php foreach ($officers as $officer) : ?>
                                <tr>
                                    ...
                                    <td class="actions text-right">
                                        <?= $this->Html->link(__('View'), ['action' => 'view', $officer->id], ['class' => 'btn btn-info btn-xs']) ?>
                                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $officer->id], ['class' => 'btn btn-warning btn-xs']) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $officer->id], ['confirm' => __('Are you sure you want to delete # {0}?', $officer->id), 'class' => 'btn btn-danger btn-xs']) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
